...
To build the final jar and optimize the cockpit application for production, run:
...
Then navigate to [http://localhost:8880](http://localhost:8880) in your browser.
